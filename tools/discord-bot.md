...
- **技能**：discord
- **位置**：`/opt/homebrew/lib/node_modules/openclaw/skills/discord/`
- **工具**：message（channel=discord）

---

## 干什么
使用 OpenClaw 操作 Discord：发送消息、创建投票、管理频道、设置状态等高级功能。
...
- **技能路径**：`/opt/homebrew/lib/node_modules/openclaw/skills/discord/`
- **工具**：message（channel=discord）

## 相关资源

- [Discord 开发者文档](https://discord.com/developers/docs/intro)
- [Discord 机器人集成](tools/discord-integration.md)
